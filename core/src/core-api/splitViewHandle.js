...
/**
 * Split view 
  Allows to open a micro frontend in a split screen in the lower part of the content area. Open it by calling `const splitViewHandle = Luigi.navigate().openAsSplitView`. 
...
export class splitViewHandle extends LuigiCoreAPIBase {
  /**
   * @private
   */
