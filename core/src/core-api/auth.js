...
class LuigiAuth {
   ...
   */
  get store() {
    if(!LuigiConfig.initialized)  console.warn("Luigi Core is not initialized yet. Consider moving your code to the luigiAfterInit lifecycle hook. Documentation: https://docs.luigi-project.io/docs/lifecycle-hooks");
    return {
      /**
