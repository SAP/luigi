<script>
  ...
  import {MessagesListeners, ViewUrlDecorator} from './services';
  import UserSettingsEditor from './UserSettingsEditor';
  import {CSS_BREAKPOINTS} from './utilities/constants';
  import {LuigiConfig} from './core-api';
  import {TOP_NAV_DEFAULTS} from './utilities/luigi-config-defaults';
  import {KEYCODE_ENTER, KEYCODE_ESC, KEYCODE_SPACE} from './utilities/keycode.js';
  ...
  function openEditor(selectedUserSettingGroup, event) {
    ...
    if (selectedUserSettingGroupData.viewUrl) {
      ...
      if (customIframes.hasOwnProperty(selectedUserSettingGroupKey)) {
        ...
        customIframes[selectedUserSettingGroupKey] = UserSettingsHelper.createIframe(
          viewUrl,
