...
import {Luigi} from './services/config';
import oauthHandler from './utilities/oauthTokenHandler'

var app;
var instance = new Luigi(() => {
  const authLib = instance.getConfigValue('auth.use');
...
export {instance as luigi, oauthHandler as defaultOauthTokenHandler}
