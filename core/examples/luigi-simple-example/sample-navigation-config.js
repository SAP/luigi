...
rootContextUpdatedFn = context => {
  console.info(
    'Context has been updated, populate to your app state, if necessary!'
  );
};

// if you are using yaas builder.js instead of luigi-client.js, set this flag to true
// warning: builder.js this is deprecated and might be removed in the future
