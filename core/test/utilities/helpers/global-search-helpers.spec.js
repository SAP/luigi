...
describe('Global-search-helpers', () => {
    ...
    describe('handleKeydown', () => {
        ...
        function assertMethodCalledWithArgs(method, args) {
            ...
            globalSearchHelpers.handleKeydown(args.result, args.event, inputElement, luigiCustomSearchItemRenderer__slotContainer);
        ...
        it('should call calcSearchResultItemSelected when ARROW_UP key is pressed', () => {
            ...
            assertMethodCalledWithArgs('calcSearchResultItemSelected', { result: null, event, expectedArgs: [KEYCODE_ARROW_UP] });
        });
    
        it('should call calcSearchResultItemSelected when ARROW_DOWN key is pressed', () => {
            const event = { keyCode: KEYCODE_ARROW_DOWN };
            assertMethodCalledWithArgs('calcSearchResultItemSelected', { result: null, event, expectedArgs: [KEYCODE_ARROW_DOWN] });
        });
        ...
        it('should call onEscape and clearAriaSelected when ESC key is pressed', () => {
            ...
            const setFocusOnGlobalSearchFieldDesktopStub = sinon.stub(globalSearchHelpers, 'setFocusOnGlobalSearchFieldDesktop');
    ...
    describe('toggleSearch', () => {
        ...
        it('should set focus on the search field if it is not visible', () => {
            ...
            globalSearchHelpers.toggleSearch(isSearchFieldVisible, displaySearchResult, inputElem, luigiCustomSearchRenderer__slot);
        ...
        it('should dispatch toggleSearch with correct parameters', () => {
            ...
            assert.isTrue(dispatchSpy.calledWith('toggleSearch', {
