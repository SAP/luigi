...
describe('Routing', function() {
  ...
  describe('handleRouteChange', () => {
    ...
    it('should trigger console warning if viewUrl is empty and there is no children node', async () => {
      // given
      const path = '#/projects/emptyViewUrl';
      component.shouldShowUnsavedChangesModal = () => false;
      const node = {};
      ...
      // then
      assert(console.log.called, 'This node was configured an empty viewUrl. Please double check it.');
    });
  });
