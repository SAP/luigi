...
if ( prepublishCheck "client-frameworks-support/testing_utilities/dist"); then
  checkRequiredFiles "client-frameworks-support/testing_utilities/dist" "luigi-mock-util.d.ts" "index.d.ts" "README.md"
  publishPackage "client-frameworks-support/testing_utilities" "client-frameworks-support/testing_utilities/dist"
fi
