...
curl https://raw.githubusercontent.com/SAP/luigi/master/core/examples/luigi-example-react/public/luigi-config/sampleconfig.js > public/luigi-config/sampleconfig.js
