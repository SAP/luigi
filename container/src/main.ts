...
if (!customElements.get('luigi-container')) {
  customElements.define('luigi-container', (LuigiContainer as ComponentType).element as CustomElementConstructor);
}

if (!customElements.get('luigi-compound-container')) {
  customElements.define(
    'luigi-compound-container',
    (LuigiCompoundContainer as ComponentType).element as CustomElementConstructor
  );
}
