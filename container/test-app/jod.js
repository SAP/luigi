...
class LuigiElement extends HTMLElement {
    ...
    */
    ...
    <div style="-webkit-font-smoothing: antialiased; color: var(--sapTextColor, #515559); padding: 20px; white-space: initial;">
      <div class="fd-section__header">
        <h1 class="fd-section__title" data-testid="jotd">Joke Of The Day &nbsp; 
          <span id="update" style="cursor: pointer; display: inline-block;">&#8634;</span></h1>
        <p id="joke-title" style="font-weight: bold;"></p>
      </div>
      <div class="fd-panel" style="font-size: 3em;">
        <div style="padding: 1em; background: var(--sapTile_Background, white)" class="jokecontainer">
        </div>
      </div>
    </div>
    `
