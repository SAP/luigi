...
export default class extends HTMLElement {
  constructor() {
    ...
    this.$coreSearchParamsBtn.addEventListener('click', () => {
      if (this.LuigiClient) {
        console.log('coreSearchParams: ', this.LuigiClient.getCoreSearchParams());
      }
    });
    ...
    this.$getPathParamsBtn.addEventListener('click', () => {
      if (this.LuigiClient) {
        console.log('getPathParams: ', this.LuigiClient.getPathParams());
      }
    });
    ...
    this.$getClientPermissionsBtn.addEventListener('click', () => {
      if (this.LuigiClient) {
        console.log('getClientPermissions: ', this.LuigiClient.getClientPermissions());
      }
    });
  }
