...
class panelHeader extends LuigiElement {
  ...
  render(ctx) {
    ...
    <div class="fd-layout-panel" ${ctx.border === 'shadow' ? 'style="border-radius: 0;"' : ''}>
      <div class="fd-layout-panel__header" ${ctx.border === 'shadow' ? 'style="border: none; box-shadow: inset 0px -1px 5px 0px var(--sapGroup_ContentBorderColor);"' : ''}>
        <div class="fd-layout-panel__head">
          <h3 id="titleCmp" class="fd-layout-panel__title">
            ${ctx.title}
          </h3>
