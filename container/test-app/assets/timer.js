...
class timer extends LuigiElement {
  ...
  render(ctx) {
    ...
    <div class="fd-step-input" id="stepInputCnt">
        <button aria-label="Step down" class="fd-button fd-button--transparent fd-step-input__button sap-icon--less"
          onclick="$_stepInputValue(-1);" tabindex="-1" type="button">
        </button>
        <input class="fd-input fd-input--no-number-spinner fd-step-input__input"
          id="stepInput" type="number" value="${ctx.initialValue || 1}">
        <button aria-label="Step up" class="fd-button fd-button--transparent fd-step-input__button sap-icon--add"
          onclick="$_stepInputValue(1);" tabindex="-1" type="button">
        </button>
    </div>
