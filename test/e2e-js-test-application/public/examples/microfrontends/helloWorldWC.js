export default class ExampleWC extends HTMLElement {
  constructor() {
    ...
    getCurrentRouteFromClosestContextBtn.innerHTML =
    ...
    getCurrentRouteFromContextBtn.innerHTML =
    ...
    getCurrentRouteFromParentBtn.innerHTML =
    ...
    getCurrentRouteFromVirtualTreeBtn.innerHTML =
    ...
    this.$currentTheme.addEventListener('click', async () => {
      if (this.LuigiClient) {
        try {
          this._shadowRoot.querySelector('span').innerHTML = JSON
            .stringify
    ...
    this.$getCurrentRouteFromClosestContextBtn = this._shadowRoot.querySelector(
      '#getCurrentRouteFromClosestContextBtn'
    );
