class GlobalSearch {
  ...
  searchProvider = {
    ...
    // customSearchResultItemRenderer(searchResultItem) {
    //   return `<a class="fd-menu__link" style="background-color:yellow;border:1px solid blue;" on:click|preventDefault="{() => {}}"><span class="fd-menu__title">${searchResultItem.label}</span></a>`;
    // },
