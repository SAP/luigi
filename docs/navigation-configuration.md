...
- **useHashRouting** defines either hash-based or path-based routing. For example, `url.com/#/yourpath`. Path-based routing is uses the common path structure. For example, ` url.com/yourpath`. 
