...
To experiment with navigation options, you can also use the [Luigi Fiddle page](https://fiddle.luigi-project.io) where you can configure a sample Luigi application.
