...
- **viewGroup** defines a group of views in the same domain sharing a common security context, which allows for example frame re-using for better performance. This property is used only for the views that use path routing internally.
