...
* To **set** feature toggles, you have two possibilities:
  ...
  ```
  2. Set feature toggles to the active feature toggle list via URL parameters by appending a comma separated array of strings. The parameter name is the predefined **featureToggles.queryStringParam** :
  ```
