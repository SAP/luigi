...
Compound web components can suppoort lazy loading of the child web components. See the [compound](navigation-parameters-reference.md#compound) parameter for details.
