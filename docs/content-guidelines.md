...
2. Save and commit your changes. If you have run `npm install` in the root folder (as indicated in the [contributing guidelines](https://github.com/SAP/luigi/blob/main/CONTRIBUTING.md)), documentation should be automatically generated and added to the `luigi-core-api.md` or `luigi-client-api.md` file on push to your branch origin. If not, you can run `lerna run docu` manually.
