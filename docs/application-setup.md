...
3. Open the directory where Luigi is installed. Search for the `luigi-config` folder. The `luigi-config.js` file in this folder can be used to configure Luigi [navigation](navigation-configuration.md), [authorization](authorization-configuration.md), [general settings](general-setting.md) and more.
...
2. Open the directory where Luigi is installed. Search for the `luigi-config` folder. The `luigi-config.js` file in this folder can be used to configure Luigi [navigation](navigation-configuration.md), [authorization](authorization-configuration.md), [general settings](general-setting.md) and more.
