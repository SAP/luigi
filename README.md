...
Read the [Getting started guide](docs/getting-started-guide.md) to learn more about what micro frontends are, what the structure of Luigi is, and what other key functions Luigi can perform.
