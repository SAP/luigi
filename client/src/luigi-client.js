...
const LuigiClient = {
  ...
  uxManager: function uxManager() {
    return {
       ...
       * @param {number} settings.closeAfter time in milliseconds that tells Luigi when to close the Alert automatically. If not provided, the Alert will stay on until closed manually.
