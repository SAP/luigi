...
const LuigiClient = {
  ...
  uxManager: function uxManager() {
    return {
       ...
       * @param {string} settings.id (optional) an identifier, unique for each Alert in queue. If not provided, will be randomly generated by Luigi.
       * @param {number} settings.closeAfter (optional) time in milliseconds that tells Luigi when to close the Alert automatically. If not provided, the Alert will stay on until closed manually.
