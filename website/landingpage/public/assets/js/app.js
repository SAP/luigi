...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#menuBtn, #closeMainNavigation').on('click', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#mainNavigation').toggleClass('is-active');
});
...
if (document.getElementById('social-list')) {
  var listItems = document.getElementById('social-list').getElementsByTagName('a');
...
module.exports = __webpack_require__(/*! /Users/markuse/Sites/projekte/kyma-project/luigi/website/landingpage/dev/src/assets/js/app.js */"./src/assets/js/app.js");
