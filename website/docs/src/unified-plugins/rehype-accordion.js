...
export default function wrapAccordion(options) {
  if (options === void 0) {
    options = { questionTagName: 'h3' };
  }
  ...
  function storeSettings(str) {
    ...
    var options = keyValues.map(function(kv) {
      return { key: kv.split(':')[0], value: kv.split(':')[1] };
    });
...
//# sourceMappingURL=rehype-accordion.js.map
